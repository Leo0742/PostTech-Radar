...
Исходный датасет, локальная SQLite-база, обученные model bundles и артефакты с примерами обращений **не публикуются**. В открытом репозитории оставлены код приложения, ML pipeline, тесты и dependency-файлы.
